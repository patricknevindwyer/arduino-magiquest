...
// The PWM pin for our motor, as well as the target speed,
// and how long to activate it (in milliseconds)
int servo_pin = 9;
int servo_pos = 0;
...
//  // reset our motor speed, as we've activated it for long enough already
//  if (servo_pos > 0) {
//    servo_pos--;
//  }
//
